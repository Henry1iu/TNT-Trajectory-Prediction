...
python train_tnt.py -d dataset/interm_tnt_n_s -o run/tnt/ -a -b 128 -c -cd 1 0 --lr 0.0010 -luf 10 -ldr 0.5
python train_tnt.py -d dataset/interm_tnt_n_s -o run/tnt/ -a -b 128 -c -cd 1 0 --lr 0.0015 -luf 10 -ldr 0.5

python train_tnt.py -d dataset/interm_tnt_n_s -o run/tnt/ -a -b 256 -c -cd 1 0 --lr 0.0010 -luf 10 -ldr 0.5
python train_tnt.py -d dataset/interm_tnt_n_s -o run/tnt/ -a -b 256 -c -cd 1 0 --lr 0.0015 -luf 10 -ldr 0.5
