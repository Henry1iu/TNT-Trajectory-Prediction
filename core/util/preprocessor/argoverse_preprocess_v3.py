...
from core.util.hmm_detector import HMMDetector
...
class ArgoversePreprocessor(Preprocessor):
    ...
    def get_ref_centerline(self, cline_list, pred_gt):
        ...
        # hmm detection
        candidate_lane_seq = self.hmm.detect(pred_gt, cline_list)
        return ref_centerlines, candidate_lane_seq[-1]
