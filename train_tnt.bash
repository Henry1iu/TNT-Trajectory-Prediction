...
python train_tnt.py -d dataset/interm_tnt_n_s_0722 -o run/tnt/ -a -b 64 -c -cd 1 0 --lr 0.0010 -luf 5 -ldr 0.3
python train_tnt.py -d dataset/interm_tnt_n_s_0722 -o run/tnt/ -a -b 64 -c -cd 1 0 --lr 0.0013 -luf 5 -ldr 0.3
