...
CUDA_VISIBLE_DEVICES=1,0 python -m torch.distributed.launch --nproc_per_node=2 train_tnt.py -d dataset/interm_data -o run/tnt/ -a -b 128 -c -m --lr 0.0012 -luf 10 -ldr 0.3
